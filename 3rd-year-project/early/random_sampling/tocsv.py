...
input_folder = 'sampled_negative'  # Replace with the path to your folder containing JSON files
output_folder = 'negatives'  # Replace with the desired output folder path
