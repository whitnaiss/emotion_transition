...
def train_and_evaluate(model_name='/root/autodl-tmp/bert-base-uncased', num_labels=2, learning_rate=6e-6, epochs=1, batch_size=16):
    # Load dataset
    ...
    with open('bert_raw_results.jsonl', 'w', encoding='utf-8') as f:
